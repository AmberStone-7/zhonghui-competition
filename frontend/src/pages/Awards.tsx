...
export default function Awards() {
  ...
  return (
    <>
      <Banner icon={Trophy} title="赛事奖项" subtitle="丰富奖品等您来拿" />
              ...
              <div key={ci}>
                ...
                <div className="grid gap-4">
                  {category.awards.map((award, ai) => (
                    <div
                      key={ai}
                      className="bg-white rounded-lg border border-gray-200 p-6 flex flex-col sm:flex-row sm:items-center gap-4"
                    >
